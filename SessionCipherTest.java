...
public class SessionCipherTest {
  ...
  private void runInteraction(SessionRecord aliceSessionRecord, SessionRecord bobSessionRecord)
    ...
    System.out.println(Arrays.equals(alicePlaintext, bobPlaintext));
    ...
    System.out.println(Arrays.equals(bobReply, receivedReply));
    ...
    for (int i=0;i<aliceCiphertextMessages.size() / 2;i++) {
      ...
      System.out.println(Arrays.equals(receivedPlaintext, alicePlaintextMessages.get(i)));
    }
    ...
    for (int i=0;i<bobCiphertextMessages.size() / 2;i++) {
      ...
      System.out.println(Arrays.equals(receivedPlaintext, bobPlaintextMessages.get(i)));
    }
...
public static void main(String[] args) {
	SessionCipherTest cipherTest = new SessionCipherTest();
	try {
		cipherTest.testBasicSessionV3();
